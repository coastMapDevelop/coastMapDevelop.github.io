		...
		if (type == 'MultiPolygon' && color == '#2471A3') {
			...
			for (i=0; i < googleSpreadsheet.length; i++) {
				if (target == googleSpreadsheet[i][0]) {
					...
					popup.setLatLng(e.latlng).setContent("<a href='www.google.com'>Test Link</a>" + "<br>" + target + " County" + "<br>" + "Population 2000: " + googleSpreadsheet[i][1] + "<br>" + "Population 2010: " + googleSpreadsheet[i][2] + "<br>" +
