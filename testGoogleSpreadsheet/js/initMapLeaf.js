		...
		if (type == 'MultiPolygon' && color == colorPal[0]) {
			...
			for (i=0; i < googleSpreadsheet.length; i++) {
				if (target == googleSpreadsheet[i][0]) {
					...
					popup.setLatLng(e.latlng).setContent("<div id='testPop'></div>" + "<b>" + target + " County</b>" + "<br>" + "Population 2000: " + googleSpreadsheet[i][1] + "<br>" + "Population 2010: " + googleSpreadsheet[i][2] + "<br>" +
