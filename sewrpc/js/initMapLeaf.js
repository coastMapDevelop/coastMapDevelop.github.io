	...
	$.ajax({
		...
		success: function(data) {
			...
			townsPolygon = L.geoJson(data, {
				...
				onEachFeature: onEachFeature,	// set onEachFeature to onEachFeature function
				filter: function(feature, layer) {
					if (feature.properties.GEOID == 5508964475 || feature.properties.GEOID == 5508906175 || feature.properties.GEOID == 5508930025) {
						return feature;
					}
				}
			});
			...
			villagesPolygon = L.geoJson(data, {
				...
				onEachFeature: onEachFeature,	// set onEachFeature to onEachFeature function
				filter: function(feature, layer) {
					if (feature.properties.GEOID == 5505450 || feature.properties.GEOID == 5511950 || feature.properties.GEOID == 5527075 || feature.properties.GEOID == 5554875 ||
						feature.properties.GEOID == 5557700 || feature.properties.GEOID == 5563300 || feature.properties.GEOID == 5573725 || feature.properties.GEOID == 5586700 ||
						feature.properties.GEOID == 5587700 || feature.properties.GEOID == 5574625) {
						return feature;
					}
				}
			});
