		...
		success: function(data) {
			...
			geojson = L.geoJson(data, {
				...
				filter: function(feature, layer) {
					if (feature.properties.STATEFP10 == 55)
					return feature;
				}
			}).addTo(map);
			...
			citiesPolygon = L.geoJson(data, {
				...
				filter: function(feature, layer) {
					if (feature.properties.LSAD == 25 && feature.properties.STATEFP == 55) {
						return feature;
					}
				}
			});
			...
			townsPolygon = L.geoJson(data, {
				...
				onEachFeature: onEachFeature,	// set onEachFeature to onEachFeature function
				filter: function(feature, layer) {
					if (feature.properties.LSAD == 43 && feature.properties.STATEFP == 55) {
						return feature;
					}
				}
			});
			...
			villagesPolygon = L.geoJson(data, {
				...
				onEachFeature: onEachFeature,	// set onEachFeature to onEachFeature function
				filter: function(feature, layer) {
					if (feature.properties.LSAD == 47 && feature.properties.STATEFP == 55) {
						return feature;
					}
				}
			});
			...
			otherPolygons = L.geoJson(data, {
				...
				onEachFeature: onEachFeature,
				filter: function(feature, layer) {
					if ((feature.properties.LSAD == 44 || feature.properties.LSAD == 21 || feature.properties.LSAD == 86 || feature.properties.LSAD == 49) && feature.properties.STATEFP == 55) {
						return feature;
					}
				}
			});
